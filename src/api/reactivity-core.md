...
- **Xem thêm**
  ...
  - [Hướng dẫn - Hiệu năng - Độ ổn định của Computed](/guide/best-practices/performance#computed-stability)
...
- **Chi tiết**
  ...
  Đối số thứ ba là một options object tùy chọn hỗ trợ các tùy chọn sau:
