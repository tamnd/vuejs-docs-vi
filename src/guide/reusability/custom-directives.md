...
Trong trường hợp có thể, hãy ưu tiên template khai báo cùng directive dựng sẵn như `v-bind`, vì chúng hiệu quả hơn và thân thiện với render phía server hơn.
